...
| `n=6`, `N=98` | max dot = **0.571037778803683** | 0.571052839653 (Henry Cohn, spherical-codes.org, 2026) | new best numerical code at verifier precision | [details](n6_N98/README.md) |

Machine-readable result summary: [`results.json`](results.json).
